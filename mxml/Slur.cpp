...
{
  Slur::Slur() {}
  bool Slur::hasType() const { return _hasType; }
  void Slur::hasType(bool value) { _hasType = value; }
  StartStopContinueEnum Slur::type() const { return _type; }
  void Slur::type(StartStopContinueEnum value) { _type = value; }
  bool Slur::hasNumber() const { return _hasNumber; }
  void Slur::hasNumber(bool value) { _hasNumber = value; }
  int Slur::number() const { return _number; }
  void Slur::number(int value) { _number = value; }

  void Slur::ostreamAttrs(pugi::xml_node& self) const
  {
  ...
  void Slur::istreamAttrs(const pugi::xml_node& self)
  {
